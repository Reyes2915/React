...
const availableSizes: Size[] = ["XS", "S", "M", "L", "XL", "XXL", "XXL"];
...
export const ProductForm = ({
  ...
  const addTag = () => {
    ...
    if (newTag === "") return;
    const newSetTags = new Set(getValues("tags"));
    newSetTags.add(newTag);
    setValue("tags", Array.from(newSetTags));
  };

  const removeTag = (tagToRemove: string) => {
    const newSetTags = new Set(getValues("tags"));
    newSetTags.delete(tagToRemove);
    setValue("tags", Array.from(newSetTags));
    // setProduct((prev) => ({
    //   ...prev,
